...
{ 
    public abstract class Notes_ConfigNodeStorage : IPersistenceLoad, IPersistenceSave
    {
        #region Constructors
        /// <summary>
        /// Class Constructor
        /// </summary>
        public Notes_ConfigNodeStorage() { }
        /// <summary>
        /// Class Constructor
        /// </summary>
        ...
        public Notes_ConfigNodeStorage(String FilePath) { this.FilePath = FilePath; }
        #endregion
